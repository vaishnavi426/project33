...
function setup() {
  ...
  button.position(canW/2-130,30);
  button.size(50,50);
  button.mouseClicked(drop);

  button1 = createImg('assets/cut_btn.png');
  button1.position(canW/2+110,30);
  button1.size(50,50);
  ...
  rope = new Rope(8,{x:canW/2-120,y:30});
  rope2 = new Rope(5,{x:canW/2+130,y:30});
  ...
  blower.position(canW/4,canH/4+50);
  blower.size(120,100);
